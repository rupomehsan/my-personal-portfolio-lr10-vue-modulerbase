...
import { contact_number_setup_store } from './setup/store';
...
export default {
            ...
            if (this.single_data) {
                this.form_fields.forEach((field, index) => {
                    Object.entries(this.single_data).forEach((value) => {
                        ...
                        if (field.name == 'note' && value[0] == 'note') {
                            $('#note').summernote('code', value[1]);
                        }
    ...
    methods: {
        ...mapActions(contact_number_setup_store, {
            get_all_data: 'all',
            get_single_data: 'get',
            store_data: 'store',
            update_data: 'update',
        ...
        setSummerEditor() {
            ...
            document.getElementById('note').appendChild(target);
        },

    },

    computed: {
        ...mapState(contact_number_setup_store, {
