                        ...
                        <table class="table table-hover text-center table-bordered">
                            ...
                            <tbody v-if="all_data.data?.length">
                                <tr v-for="(item, index) in all_data.data" :key="item.id">
                                    ...
                                    <th> <img :src="item.image" alt="" height="20" width="30"> </th>
                                    <td>{{ item.status }}</td>
...
import { blood_doner_setup_store } from './setup/store';
...
export default {
    ...
    methods: {
        ...mapActions(blood_doner_setup_store, {
            get_all_data: 'all',
            delete_data: 'delete',
    ...
    computed: {
        ...mapState(blood_doner_setup_store, {
            all_data: 'all_data',
        })
    }
}
