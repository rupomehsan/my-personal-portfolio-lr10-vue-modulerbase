...
export default {
    ...
    created: async function () {
        ...
        await this.get_all_todolist_categories()

        if (this.all_todolist_categories_data) {
            this.form_fields[0].data_list = []
            this.all_todolist_categories_data.forEach((item) => {
                let dataList = {}
    ...
    methods: {
        ...mapActions(todo_list_setup_store, {
            ...
            store_data: 'store',
            update_data: 'update',
            get_all_todolist_categories: 'get_all_todolist_categories',
        }),
    ...
    computed: {
        ...mapState(todo_list_setup_store, {
            ...
            all_todolist_categories_data: 'all_todolist_categories_data',
        }),
    },
